...
import com.example.kotlinweatherapp.data.db.LocalDateConverter
import com.example.kotlinweatherapp.internal.DateNotFoundException
...
class FutureDetailWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    // For the kodeIn factory that will return the view model factory
