...
import com.example.kotlinweatherapp.data.db.unitlocalized.future.detail.ImperialDetailFutureWeatherEntry
import com.example.kotlinweatherapp.data.db.unitlocalized.future.detail.MetricDetailFutureWeatherEntry
import com.example.kotlinweatherapp.data.db.unitlocalized.future.list.ImperialSimpleFutureWeatherEntry
...
interface FutureWeatherDao {
    ...
    //select * because there is in forecast db date is unique
